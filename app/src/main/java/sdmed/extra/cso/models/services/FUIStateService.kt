...
class FUIStateService {
    ...
    fun loading(isVisible: Boolean = true, msg: String = "", indicatorColor: Color? = null, textColor: Color? = null) {
        if (isVisible) {
            isLoading.value = LoadingMessageModel.Visible(msg, indicatorColor, textColor)
        } else {
