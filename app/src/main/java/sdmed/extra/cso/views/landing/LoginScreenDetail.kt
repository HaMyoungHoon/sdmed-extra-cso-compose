...
class LoginScreenDetail {
    val headerHeight = 48.dp
    @Composable
    fun screen(viewModel: LoginScreenVM) {
        val id by remember { viewModel.id }.collectAsState()
        val pw by remember { viewModel.pw }.collectAsState()
    ...
    @Composable
    fun loginBody(viewModel: LoginScreenVM) {
    ...
    @Composable
    fun loginTail(viewModel: LoginScreenVM) {
    ...
    @Composable
    fun idDecorationBox(innerTextField: @Composable () -> Unit, text: String, color: IBaseColor) {
        if (text.isEmpty()) {
            customText(CustomTextData().apply {
    ...
    @Composable
    fun pwDecorationBox(innerTextField: @Composable () -> Unit, text: String, color: IBaseColor) {
        if (text.isEmpty()) {
            customText(CustomTextData().apply {
